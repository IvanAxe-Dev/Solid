...
//Порушено принцип DIP(Dependency Inversion Principle)
//Механізм виводу інформації був напряму записаний в класі EmailSender, що ускладнювало можливу заміну цього механізму.
//Виправлено додаванням інтерфейсу ILogger для опрацювання виводу, що зробить цей механізм незалежним від класу EmailSender
//та гнучким при зміні та додаванні нових способів відображення інформації.
